...
public class ChatManager : MLAPI.NetworkBehaviour {

    // reference to BotUI class
    public BotUI botUI; //M: Cambiar por una referencia al AvatarServerState de quien le este hablando
    public ulong talkingPartner = 0; //0 corresponde al servidor, ningun cliente tendra esta ID
    
    // the url at which bot's custom connector is hosted
    private const string rasa_url = "http://25.82.37.149:5005/webhooks/rest/webhook"; //M:Queda igual
